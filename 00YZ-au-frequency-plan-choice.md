...
It is proposed to use the standard Helium on-chain voting system [Helium Vote](https://heliumvote.com) to allow any wallet to vote on this HIP. See [Voting on Helium](https://docs.helium.com/community-voting/) documentation on Helium Docs.
