...
At the time of transition a snapshot will be taken of the Helium blockchain state and any staked HNT will be immediately converted to veHNT with the minimum lockup period. This will also include any staked HNT that has not completed the full 125,000 blocks (as adjusted above) of cooldown. Validators who have completed cooldown will have their stakes released at the snapshot and will received unlocked HNT after the migration. This enables all staked HNT holders to continue to participate in the ecosystem by assigning their veHNT to a subDAO (IOT or MOBILE) in order to influence the DAO’s Utility Score, participate in new Subnetwork Proposals, or participate in overall governance of the Helium Network.
