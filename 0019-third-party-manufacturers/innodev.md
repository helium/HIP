...
**Firmware** - Partially done
 ...
 - Integration with Helium app (Android/iOS) - **On-going**
 - Other software modules (enclosure thermal management and protection, light signaling drivers) – **On-going**
...
**Figure 3 - Enclosure**
 ...
 - Assembly line facility – **On-going** - we have our own new warehouse that will be prepared for device final assembling, automated testing and packaging.
...
**LoRa module**
LoRa module is designed and produced by us. It is a mPCIe module, and uses SPI and GIO for communication. The chipset is SX1302 & SX1250 in order to use the fine timestamps feature of this chipset to implement higher accuracy location services in the future. This radio module is designed by us, and produced in factories in China and Germany, as backup. There are other LoRa mPCIe modules on the market but we prefer to produce our own, in order to decrease the dependency to other partners and procurement risks. We can produce RF modules as much as we need according to the orders. Components for it will be procured from different distribution partners from UK, Romania and China
...
Our experience includes workinf with technologies like  Zigbee, BLE and GSM. We designed and produced gateways used in different IoT industrial applications like:
