...
2. Obtain ENERGY subnetwork governance approval (this HIP also provides governance approval for Srcful AB to be the first Service Provider when the network launches).
