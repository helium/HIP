...
|:--:|
| ![Attach Call Flow](https://freedomfi.atlassian.net/wiki/download/attachments/687669250/Attach+call+flow.png?version=11) |

| **Fig.2 - Update Call Flow**|
|:--:|
| ![Update Call Flow](https://freedomfi.atlassian.net/wiki/download/attachments/687669250/Update+call+flow.png?version=9) |

| **Fig.3 - UE Termination Call Flow**|
|:--:|
| ![UE Termination Call Flow](https://freedomfi.atlassian.net/wiki/download/attachments/687669250/UE+Terminate+call+flow.png?version=10) |

| **Fig.4 - Network Termination Call Flow**|
|:--:|
| ![Network Termination Call Flow](https://freedomfi.atlassian.net/wiki/download/attachments/687669250/Network+Terminate+call+flow.png?version=7) |
