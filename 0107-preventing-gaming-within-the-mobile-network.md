...
One alternative is to give the MOBILE subDAO the power to bank hotspots, similar to how CrowdSpot operated on the IOT network. However, as there were flaws to that method, CrowdSpot no longer exists. 
