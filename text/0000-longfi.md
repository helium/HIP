...
- Downlink: 64 downlink channels utilizing LoRa 500 kHz bandwidth using coding rate 4/5. The channels are numbered 1 to 64 and the frequencies are to be determined.
