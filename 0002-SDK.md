...
Incoming demo on HeliOS++ will contrast a "Arduino app", compiled in traditional Arduino context vs [detox-rs](https://github.com/helium/detox-rs). It will have an identical, familiar, Wiring API but with notable metrics worth comparing:
- total binary size
